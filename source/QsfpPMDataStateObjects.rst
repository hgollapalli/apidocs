...
::
	...
	if __name__ == '__main__':
		...
		response, error = fSwitch.getQsfpPMDataState(Resource=resource, Class=class, QsfpId=qsfpid)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		fSwitch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = fSwitch.getQsfpPMDataStateById(ObjectId=objectid)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		fSwitch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = fSwitch.getAllQsfpPMDataStates()

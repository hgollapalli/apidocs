...
**FlexSwitch CURL API Supported:**
	...
	- CREATE(POST)
		 curl -X POST -H 'Content-Type: application/json' --header 'Accept: application/json' -d '{<Model Object as json-Data>}' http://device-management-IP:8080/public/v1/config/LLDPIntf
	- DELETE By Key
		 curl -X DELETE -i -H 'Accept:application/json' -d '{<Model Object as json data>}' http://device-management-IP:8080/public/v1/config/LLDPIntf
	- DELETE By ID
		 curl -X DELETE http://device-management-IP:8080/public/v1/config/LLDPIntf<uuid>
	- UPDATE(PATCH) By Key

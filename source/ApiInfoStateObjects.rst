...
------------------------------------
	...
	- GET By ID
		 curl -X GET http://device-management-IP:8080/public/v1/config/ApiInfoState/<uuid>
...
::
	...
	if __name__ == '__main__':
		...
		response, error = swtch.getApiInfoState(Url=url)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.getApiInfoStateById(ObjectId=objectid)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		swtch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = swtch.getAllApiInfoStates()

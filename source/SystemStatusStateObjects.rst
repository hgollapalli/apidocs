...
::
	...
	if __name__ == '__main__':
		...
		response, error = fSwitch.getSystemStatusState(Name=name)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		fSwitch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = fSwitch.getSystemStatusStateById(ObjectId=objectid)
...
::
	...
	if __name__ == '__main__':
		switchIP := "192.168.56.101"
		fSwitch = FlexSwitch (switchIP, 8080)  # Instantiate object to talk to flexSwitch
		response, error = fSwitch.getAllSystemStatusStates()
